...
let partsNeeded = 40;
console.log('Needed Parts:', partsNeeded);
...
let pushedParts = 25;
supplyChanges.push(pushedParts);
console.log(supplyChanges);
console.log('Pushed amount of parts:', supplyChanges[supplyChanges.length -1]);
...
let stretchZeroes = [];
for (let sign of supplyChanges) {
  if (sign > 0){
    stretchPositives.push(sign)
  }
  if (sign < 0) {
    stretchNegatives.push(sign)
  }
  else if (sign === 0){
    stretchZeroes.push(sign)
  }
}
